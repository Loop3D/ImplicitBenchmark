...
# Load horizons
Columns2Gocad File_name "..\Full\H1.csv" classifications "None+None+None+None+" columns "1+2+3+4+" cs_settings "Domain=Default_depth" delimited 1 end_line 0 limits "merge_delimiters=0+0 	;" names "X+Y+Z+Strati+" ndvs "-99999+-99999+-99999+-99999+" options "name+H1+category+Horizons+role+Picks" output_type "pointset" start_line 2 use_ndvs "0+0+0+1+";
Columns2Gocad File_name "..\Full\H2.csv" classifications "None+None+None+None+" columns "1+2+3+4+" cs_settings "Domain=Default_depth" delimited 1 end_line 0 limits "merge_delimiters=0+0 	;" names "X+Y+Z+Strati+" ndvs "-99999+-99999+-99999+-99999+" options "name+H2+category+Horizons+role+Picks" output_type "pointset" start_line 2 use_ndvs "0+0+0+1+";
Columns2Gocad File_name "..\Full\H3.csv" classifications "None+None+None+None+" columns "1+2+3+4+" cs_settings "Domain=Default_depth" delimited 1 end_line 0 limits "merge_delimiters=0+0 	;" names "X+Y+Z+Strati+" ndvs "-99999+-99999+-99999+-99999+" options "name+H3+category+Horizons+role+Picks" output_type "pointset" start_line 2 use_ndvs "0+0+0+1+";
Columns2Gocad File_name "..\Full\H4.csv" classifications "None+None+None+None+" columns "1+2+3+4+" cs_settings "Domain=Default_depth" delimited 1 end_line 0 limits "merge_delimiters=0+0 	;" names "X+Y+Z+Strati+" ndvs "-99999+-99999+-99999+-99999+" options "name+H4+category+Horizons+role+Picks" output_type "pointset" start_line 2 use_ndvs "0+0+0+1+";
Columns2Gocad File_name "..\Full\H5.csv" classifications "None+None+None+None+" columns "1+2+3+4+" cs_settings "Domain=Default_depth" delimited 1 end_line 0 limits "merge_delimiters=0+0 	;" names "X+Y+Z+Strati+" ndvs "-99999+-99999+-99999+-99999+" options "name+H5+category+Horizons+role+Picks" output_type "pointset" start_line 2 use_ndvs "0+0+0+1+";
Columns2Gocad File_name "..\Full\H6.csv" classifications "None+None+None+None+" columns "1+2+3+4+" cs_settings "Domain=Default_depth" delimited 1 end_line 0 limits "merge_delimiters=0+0 	;" names "X+Y+Z+Strati+" ndvs "-99999+-99999+-99999+-99999+" options "name+H6+category+Horizons+role+Picks" output_type "pointset" start_line 2 use_ndvs "0+0+0+1+";
Columns2Gocad File_name "..\Full\H7.csv" classifications "None+None+None+None+" columns "1+2+3+4+" cs_settings "Domain=Default_depth" delimited 1 end_line 0 limits "merge_delimiters=0+0 	;" names "X+Y+Z+Strati+" ndvs "-99999+-99999+-99999+-99999+" options "name+H7+category+Horizons+role+Picks" output_type "pointset" start_line 2 use_ndvs "0+0+0+1+";
Columns2Gocad File_name "..\Full\H8.csv" classifications "None+None+None+None+" columns "1+2+3+4+" cs_settings "Domain=Default_depth" delimited 1 end_line 0 limits "merge_delimiters=0+0 	;" names "X+Y+Z+Strati+" ndvs "-99999+-99999+-99999+-99999+" options "name+H8+category+Horizons+role+Picks" output_type "pointset" start_line 2 use_ndvs "0+0+0+1+";
Columns2Gocad File_name "..\Full\H9.csv" classifications "None+None+None+None+" columns "1+2+3+4+" cs_settings "Domain=Default_depth" delimited 1 end_line 0 limits "merge_delimiters=0+0 	;" names "X+Y+Z+Strati+" ndvs "-99999+-99999+-99999+-99999+" options "name+H9+category+Horizons+role+Picks" output_type "pointset" start_line 2 use_ndvs "0+0+0+1+";
