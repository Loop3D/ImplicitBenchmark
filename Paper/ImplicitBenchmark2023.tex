...
\todo[inline]{Sorry for taking so long to get back to this project. Feedback welcome.}
...
In the SIGMA code \cite{Irakarama2021MG}, Lagrange polynomials defined on a Cartesian grid are used to discretize the data. The basis functions which control the smoothing term are estimated using finite differences. LoopStructural and MSS also implement some finite difference operators. \todo{@Modeste, do you want to add something on the CAD 2022 approach ?}
