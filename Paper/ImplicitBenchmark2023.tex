...
\todo[inline]{Need to say a few words on the machine learning based methods in the introduction ? Or just mention that they are out of scope of the methods review ?}
...
\todo[inline]{
I removed some considerations to delay them to the discussion. Previous comments: 
